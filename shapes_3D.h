...
public:
	...
	Face(Vect3 v0, Vect3 v1, Vect3 v2) { add_vertex(v0); add_vertex(v1); add_vertex(v2); }  // For tris
	Face(Vect3 v0, Vect3 v1, Vect3 v2, Vect3 v3) { add_vertex(v0); add_vertex(v1); add_vertex(v2); add_vertex(v3); }  // For quads
...
public:
	...
	void create_faces()
	{
		...
		Face face0{ vert0, vert1, vert2, vert3 };    faces.push_back(face0);
		Face face1{ vert4, vert5, vert6, vert7 };    faces.push_back(face1);
		Face face2{ vert0, vert4, vert5, vert1 };    faces.push_back(face2);
		Face face3{ vert3, vert7, vert6, vert2 };    faces.push_back(face3);
		Face face4{ vert7, vert4, vert0, vert3 };    faces.push_back(face4);
		Face face5{ vert6, vert5, vert1, vert2 };    faces.push_back(face5);
...
public:
	...
	void expand(Vect3 new_point)
	{
		...
		if (p_x < this->top_left.get_x()) this->top_left.set_x(p_x);  if (p_x > this->bottom_right.get_x()) this->bottom_right.set_x(p_x);
		if (p_y > this->top_left.get_y()) this->top_left.set_y(p_y);  if (p_y < this->bottom_right.get_y()) this->bottom_right.set_y(p_y);
		if (p_z > this->top_left.get_z()) this->top_left.set_z(p_z);  if (p_z < this->bottom_right.get_z()) this->bottom_right.set_z(p_z);
	}
};